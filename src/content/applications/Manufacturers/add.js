...
function ApplicationsAddManufacturers() {
  ...
  const [sectionsDosageFormsApproved, setSectionsDosageFormsApproved] =
    React.useState('');
  const [indianGMPStatusStateGMP, setIndianGMPStatusStateGMP] =
    React.useState('');
  const [internationalGMPStatus, setInternationalGMPStatus] =
    React.useState('');
          ...
          >
            <Grid item xs={4}>
              ...
              <FormControl margin="normal" fullWidth>
                ...
                <Select
                  ...
                  autoFocus
                  helperText={
                    formik.errors.typesOfProducts
                      ? formik.errors.typesOfProducts
                      : ''
                  }
                  error={formik.errors.typesOfProducts ? true : false}
                >
              ...
              <FormControl margin="normal" fullWidth>
                <InputLabel id="internationalGMPStatus">
                ...
                <Select
                  ...
                  autoFocus
                  helperText={
                    formik.errors.internationalGMPStatus
                      ? formik.errors.internationalGMPStatus
                      : ''
                  }
                  error={formik.errors.internationalGMPStatus ? true : false}
                >
            ...
            <Grid item xs={4}>
              <TextField
                ...
                helperText={
                  formik.errors.noOfPlants ? formik.errors.noOfPlants : ''
                }
              />
              <TextField
                margin="normal"
              ...
              <FormControl margin="normal" fullWidth>
                <InputLabel id="sectionsDosageFormsApproved">
                  Sections - Dosage Forms Approved
                </InputLabel>
                <Select
                  ...
                  autoFocus
                  helperText={
                    formik.errors.sectionsDosageFormsApproved
                      ? formik.errors.sectionsDosageFormsApproved
                      : ''
                  }
                >
              ...
              <FormControl margin="normal" fullWidth>
                <InputLabel id="nonPharmaActivities">
                ...
                <Select
                  ...
                  autoFocus
                  helperText={
                    formik.errors.nonPharmaActivities
                      ? formik.errors.nonPharmaActivities
                      : ''
                  }
                >
            ...
            <Grid item xs={4}>
              ...
              <FormControl margin="normal" fullWidth>
                <InputLabel id="availability of manufacturing license">
                ...
                <Select
                  ...
                  onChange={
                    formik.handleChangeAvailabilityOfManufacturingLicense
                  }
                  autoFocus
                  helperText={
                    formik.errors.availabilityOfManufacturingLicense
                      ? formik.errors.availabilityOfManufacturingLicense
                      : ''
                  }
                >
              ...
              <FormControl margin="normal" fullWidth>
                <InputLabel id="indianGMPStatusStateGMP">
                ...
                <Select
                  ...
                  autoFocus
                  helperText={
                    formik.errors.indianGMPStatusStateGMP
                      ? formik.errors.indianGMPStatusStateGMP
                      : ''
                  }
                >
